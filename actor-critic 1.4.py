...
actual_state = np.zeros(gaussian_number)
...
if __name__ == "__main__":
    ...
    for trial in xrange(n_trial):
        ...
        T = 1 * np.exp(- trial   * 0.4 / float(n_trial))
     #   print "T"
       # print T
        ...
        #  if trial / 2 ==0:
       #     agent_starting_position = 0.02
       # else:
       #     agent_starting_position = 0.98
     #   actual_reward = 0
           ...
           # print actual_noise
            ...
            if trial == 0:
                ...
                if movement == 0:
                    ...
                    equilibrium, = ax1.plot([EP], [0], '*')
                    plt.pause(0.000001)
                    
            else:
                
                equilibrium.set_data(EP , 0)
                plt.pause(0.000001)
         ...
         #   print "EP"
          #  print EP
            ...
            if movement > 0:
                ...
                actual_critic_output = spreading(critic_weights, actual_state)
    ...
    plt.xticks(np.arange(0,n_trial, 20))
